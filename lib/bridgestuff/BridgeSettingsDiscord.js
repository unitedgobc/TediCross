...
class BridgeSettingsDiscord {
	 ...
	 * @param {String} settings.webhookId	ID of the webhook of the discord channel that this bridge will use to publish messages from Telegram to discord
	 ...
	 * @param {Boolean} settings.showSenderNameInMessageHeader Whether or not to show the sender's name (in bold) at the start of the message 
	...
	constructor(settings) {
		...
		this.showSenderNameInMessageHeader = settings.showSenderNameInMessageHeader;
	}
